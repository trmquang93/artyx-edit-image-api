...
def handler(job):
    ...
    try:
        ...
        if model_manager is None:
            ...
            # Add multiple possible paths for RunPod environment
            current_dir = os.path.dirname(os.path.abspath(__file__))
            possible_paths = [
                current_dir,
                os.path.join(current_dir, ".."),
                "/var/task",  # AWS Lambda style
                "/app",       # Docker style
                "."           # Current directory
            ]
            ...
            try:
                ...
                logger.info("Successfully imported QwenImageManager")
            except ImportError as e:
                logger.error(f"Failed to import QwenImageManager: {e}")
